      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
          ...
          >
            ...
            <Link to="/dashboard" className="w-full py-4 rounded-2xl border-2 border-slate-200 text-slate-700 font-bold text-center hover:border-slate-300 hover:bg-slate-50 transition-all">
              免费开始
            </Link>
          </motion.div>
          ...
          >
            ...
            <Link to="/dashboard" className="w-full py-4 rounded-2xl bg-indigo-600 text-white font-bold text-center hover:bg-indigo-500 transition-all shadow-[inset_-4px_-6px_25px_0px_rgba(255,255,255,0.1),inset_4px_4px_10px_0px_rgba(0,0,0,0.2)]">
              立即订阅
            </Link>
          </motion.div>
          ...
          >
            ...
            <Link to="/dashboard" className="w-full py-4 rounded-2xl border-2 border-slate-900 text-slate-900 font-bold text-center hover:bg-slate-900 hover:text-white transition-all">
              联系销售
            </Link>
          </motion.div>
