...
export default function Landing() {
  ...
  const videoBlur = useTransform(scrollY, [0, 1000], [0, 20]);
  const videoFilter = useTransform(videoBlur, blur => `contrast(1.1) brightness(0.9) blur(${blur}px)`);
    ...
    <div className="min-h-screen bg-white selection:bg-indigo-100 selection:text-indigo-900 relative">
      ...
      <section className="relative min-h-screen flex justify-center overflow-hidden bg-white">
        ...
        <div className="absolute inset-0 z-0 h-full w-full">
          ...
          {/* Gradient overlay to blend video into the background color */}
        ...
        >
          ...
          >
            <div className="flex items-center w-full bg-[#fcfcfc] rounded-[40px] border border-gray-200/80 p-1.5 shadow-[0px_10px_40px_5px_rgba(194,194,194,0.25)]">
              ...
              />
              <Link to="/dashboard" className="bg-slate-900 text-white rounded-full px-8 py-3.5 font-medium text-sm shadow-[inset_-4px_-6px_25px_0px_rgba(201,201,201,0.08),inset_4px_4px_10px_0px_rgba(29,29,29,0.24)] whitespace-nowrap transition-transform hover:scale-[1.02] active:scale-[0.98]">
                免费试用
              </Link>
            </div>
      ...
      <section className="py-32 relative z-10">
        <ScrollReveal className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="mt-24 text-center">
            <Link to="/dashboard" className="inline-flex items-center gap-2 bg-slate-900 text-white rounded-full px-10 py-4 font-medium text-lg shadow-[inset_-4px_-6px_25px_0px_rgba(201,201,201,0.08),inset_4px_4px_10px_0px_rgba(29,29,29,0.24)] transition-transform hover:scale-[1.02] active:scale-[0.98]">
              立即开始使用
            </Link>
          </div>
        </ScrollReveal>
